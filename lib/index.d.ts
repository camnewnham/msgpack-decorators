...
export declare function decode<T>(data: ArrayLike<number> | BufferSource, objectType: Class<T> | AbstractClass): T;
export declare function serialize(obj: object, objectType?: AbstractClass): {};
export declare function deserialize<T>(data: any[] | {}, objectType: Class<T> | AbstractClass): T;
